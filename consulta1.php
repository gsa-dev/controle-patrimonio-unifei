...
$sqlLista = "SELECT * FROM emprestimo JOIN patrimonio ON emprestimo.id_patrimonio = patrimonio.id";
...
<form class="w3-container w3-card-4" action="CONSULTA_TESTE.php" method="GET">
<br>

<p>
    <input class="w3-input" type="text" name ="pesquisa" placeholder="Digite o número de série ou nome do Item" style="width:90%" required>
<p>
