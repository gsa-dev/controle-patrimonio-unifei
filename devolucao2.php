...
<html>
    ...
    <body>
        ...
        $nSerie = $_POST["nSerie"];
        $sql = "SELECT * FROM emprestimo JOIN patrimonio ON emprestimo.id_patrimonio = patrimonio.id  where numero_serie LIKE '%$nSerie%'";
        $result = $conn->query($sql);
        $dados = $result->fetch_assoc();

        if (empty($dados)) {
            header("Location:devolucao1.php");
        } else {
        ...
        <div class="w3-main" style="margin-left:250px;">
            ...
            <div class="w3-container w3-padding-32" style="padding-left:32px">
                ...
                <div action="form.asp" class="w3-card-4">
                    <form class="w3-container" action="cadastra_devolucao.php?id_p=<?php echo $dados["id_patrimonio"]; ?>" method="post">
                        ...
                        <p>
                            <label class="w3-label w3-validate" style="color:black">Condições</label></p>
                        <input class="w3-input w3-border" type="text" style="width:90%; height:150px" name="condicoes"   value="<?php echo $dados["condicoes"]; ?>"required>
...
<?php }  else {
                          ...
                          echo("<script type='text/javascript'> alert('Já foi Devolvido!'); location.href='pagina_principal.php';</script>");
